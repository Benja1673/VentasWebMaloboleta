                            ...
                            if (doc.Element("DETALLE_COMPRA") != null)
                            {
                                rptDetalleCompra = (from dato in doc.Elements("DETALLE_COMPRA")
                                                    select new Compra()
                                                    {
                                                        ...
                                                        TotalCosto = Convert.ToInt32(dato.Element("TotalCosto").Value), // Cambiado a Convert.ToInt32
                                ...
                                rptDetalleCompra.oListaDetalleCompra = (from producto in doc.Element("DETALLE_COMPRA").Element("DETALLE_PRODUCTO").Elements("PRODUCTO")
                                                                        select new DetalleCompra()
                                                                        {
                                                                            ...
                                                                            PrecioUnitarioCompra = Convert.ToInt32(producto.Element("PrecioUnitarioCompra").Value), // Cambiado a Convert.ToInt32
                                                                            TotalCosto = Convert.ToInt32(producto.Element("TotalCosto").Value) // Cambiado a Convert.ToInt32
                                                                        }).ToList();
                            }
                            else
                            {
